...
- **Injuries:** All healed or healing rapidly. Wolf bite closed over in days (unusual speed). Ribs mended. Knee functional. Palm scar thinned. The healing rate is the first mechanical sign of the consumption's effects.
...
- **The Bleed stage:** Early-to-middle. Corrections now have Hakiia's rhythm and patience. Corrected a MEMORY with information Hurkuzak shouldn't have (Hakiia's tactical reason for the ridge: sightlines vs. wolves). Voice has opinions beyond survival — dislikes his eating pace, reads structures the way Hakiia did. Still dismissable but the dismissal is thinning. Has not been named. Reader should feel it is Hakiia; Hurkuzak refuses the conclusion.
...
- **Knowledge of Hurkuzak:** Has found his track on a logging trail east of the trading post settlement. Identified it as demon, augmented, tactically sophisticated. Hypothesizes sibling consumption based on the profile (capabilities beyond standard augmentation, learned rather than inherited quality to movement). Has connected the track to Koss's premium buyer. Does not yet know his name or history. Following east.
