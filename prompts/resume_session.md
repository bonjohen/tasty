# Resume Session — Tasty Novel Project

You are continuing work on the novel "Tasty." This document loads your context after a clear. Read it fully, then execute `prompts/chapter_prompt.md`.

## What This Project Is

A literary dark fantasy novel. 48 chapters across 23 sections. You are writing the prose chapter files following detailed section outlines.
...
6. The previous and next section outlines (for handoff context)
7. The most recent 1–2 written chapters (for prose rhythm and scene handoff)

## Key Creative Decisions (Summary)
...
- **Demons:** Modified humans from a magically warped region. Can pass for human. Called "demons" by outsiders.
- **Flesh economy:** Structured, multi-tiered, normalized. Not fringe — civilizational infrastructure.
...
All 23 section outlines exist: `docs/section_01_outline.md` through `docs/section_23_outline.md`. Each contains chapter numbers, POV, word targets, detailed beats, function paragraphs, and notes.

## Process

After reading this document and the required files listed above, execute `prompts/chapter_prompt.md`. That prompt contains the complete sequential process: determine next unwritten chapter, read outlines, draft, save, verify, update continuity, continue to next chapter, commit and push at section boundaries, then begin the next section.
